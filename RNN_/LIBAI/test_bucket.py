...
if __name__ == '__main__':
    ...
    train_sent, vocab = tokenize_text("../input/ptb.train.txt", start_label=start_label,
                                      invalid_label=invalid_label)
    val_sent, _ = tokenize_text("../input/ptb.train.txt", vocab=vocab, start_label=start_label,
                                invalid_label=invalid_label)
